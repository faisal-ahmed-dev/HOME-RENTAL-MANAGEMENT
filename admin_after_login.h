...
private slots:
    ...
    void on_pushButton_building_pic_clicked();

    void on_pushButton_customize_pic_clicked();

    void on_pushButton_search_pic_clicked();

    void on_pushButton_trans_pic_clicked();

    void on_pushButton_maintenance_pic_clicked();
